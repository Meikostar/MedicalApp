...
public final class Picker {
     ...
     * @param add_watermark
     */
    public Picker set(boolean add_watermark) {
        this.add_watermark = add_watermark;
        return this;
    }

    public Picker setWatermark(String watermark) {
    ...
    public void forResult(final int requestCode) {
        PermissionUtils.requestPermission(mContext.get(), PermissionUtils.CODE_READ_EXTERNAL_STORAGE, new PermissionUtils.PermissionGrant() {
            @Override
            public void onPermissionGranted(int perRequestCode) {
                switch (perRequestCode) {
