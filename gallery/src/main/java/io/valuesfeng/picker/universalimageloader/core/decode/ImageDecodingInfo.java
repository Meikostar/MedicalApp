 ...
 *******************************************************************************/
package io.valuesfeng.picker.universalimageloader.core.decode;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.mykar.framework.ui.view.image.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
