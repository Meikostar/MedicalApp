...
import io.valuesfeng.picker.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import io.valuesfeng.picker.universalimageloader.core.assist.FlushedInputStream;
...
import io.valuesfeng.picker.universalimageloader.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 * By default: disk cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.mykar.framework.ui.view.image.universalimageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		 * will be used as disk cache. You can use {@link #diskCache(DiskCache)} method for introduction your own
		 * implementation of {@link DiskCache}
		 */
		 ...
		 * Default value - {@link com.mykar.framework.ui.view.image.universalimageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.mykar.framework.ui.view.image.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
